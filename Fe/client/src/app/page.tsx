	...
	return (
		<section className="py-20 bg-white dark:bg-gray-900">
			<div className="container mx-auto px-4">
				<AnimatedSection>
					<h2 className="text-3xl font-bold text-center mb-4 sm:text-4xl lg:text-5xl">
						Tất cả những gì bạn cần, tất cả những gì bạn muốn
					</h2>
					<p className="text-lg text-center text-gray-600 dark:text-gray-300 mb-12 max-w-3xl mx-auto">
						Astro cung cấp mọi thứ bạn cần để bắt đầu một trang web hỗ trợ tìm kiếm và quản lý trọ, kết hợp
						những tính năng tốt nhất từ các công cụ hiện đại và thêm vào những đổi mới độc đáo của riêng
						mình.
					</p>
				</AnimatedSection>
