...
export default function RentalListings({ userId }: { userId?: string }) {
	...
	return (
		<div className="container mx-auto p-4">
			<h1 className="text-2xl font-bold mb-4">Danh sách tin cho thuê</h1>
			<div className="flex justify-end py-2">
				{isAuthenticated && userId === undefined && role === "ROLE_LANDLORD" &&
				...
				isFetching
					...
					: <div className="w-full lg:w-3/4">
						<div className="space-y-4 pb-4">
							{rentalPosts !== undefined && rentalPosts.length > 0
