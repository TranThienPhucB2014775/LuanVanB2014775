...
import RoomTypeDetail from "./RoomDetail.jsx";
...
function ListRoom() {
    ...
    const {data, isLoading, sendRequest} = useHttp(getALlRoom, {
        data: [],
        totalElements: 0,
        totalPage: 0,
    });
    ...
    const params = useMemo(() => {
        ...
        RoomTypeId && queryParams.append("roomTypeId", RoomTypeId);
    ...
    return (
        <>
            <PageHeadin heading={RoomTypeId ? "Thông tin Khu trọ" : "Loại phòng trọ"}/>
            {RoomTypeId && <RoomTypeDetail id={RoomTypeId}/>}
            <Row className="px-2">
                <Card>
                    <Card.Header className="bg-white py-4">
                        <h4 className="mb-0">{`Danh sách loại phòng trọ${RoomTypeId ? " của khu trọ này" : ""}`}</h4>
                    </Card.Header>
                    <Navbar
                        expand="lg"
                    ...
                    <TableRoom data={data.data} loader={isLoading}/>
