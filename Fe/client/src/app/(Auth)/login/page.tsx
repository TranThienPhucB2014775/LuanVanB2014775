        ...
        <div className="w-full h-[560px] bg-white ct-center">
            <div className="w-[320px]">
                <div className="w-full bg-white">
                    <a href={targetUrl}>
                        <Button
                            claesses="border-[1px] border-solid border-Neutral-B500 flex flex-row gap-[5px]"
                        >
                            <Image
                                src={logoGoogle}
                                width={24}
                    ...
                    <div
                        className="mt-[32px] relative w-full after:absolute after:top-1/2 after:left-0 after:w-full after:h-[1px] after:bg-black ct-center">
