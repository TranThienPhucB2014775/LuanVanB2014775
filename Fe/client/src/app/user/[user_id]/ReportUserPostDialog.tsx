...
function ReportUserPostDialog({ rentalPostId }: ReportDialogProps) {
	...
	const {
		...
		(data: {
			...
			message: string,
			sessionToken: string
		}) => accountApiRequest.reportAccount(data)
	);
...
export default ReportUserPostDialog;