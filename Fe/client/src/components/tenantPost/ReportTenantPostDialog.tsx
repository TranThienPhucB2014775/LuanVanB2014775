...
function ReportTenantPostDialog({ rentalPostId }: ReportDialogProps) {
	...
	const {
		...
		(data: {
			...
			message: string,
			sessionToken: string
		}) => tenantPostApiRequest.reportTenantPost(data)
	);
...
export default ReportTenantPostDialog;