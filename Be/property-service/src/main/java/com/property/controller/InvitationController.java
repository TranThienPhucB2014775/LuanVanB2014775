...
public class InvitationController {
    ...
    public ApiResponse<?> inviteTenant(
            @RequestBody @Valid InviteTenantToRoomRequest request,
    ...
    @PostMapping("/refuse")
    public ResponseEntity<ApiResponse<String>> refuseInvite(
            @RequestBody @Valid RefuseInviteRequest request
    ) {
        log.info("Inviting tenant to room");
    ...
    @PostMapping("/disable")
    public ResponseEntity<ApiResponse<String>> disableInvite(
            @RequestBody @Valid DisableInviteRequest request
    ) {
