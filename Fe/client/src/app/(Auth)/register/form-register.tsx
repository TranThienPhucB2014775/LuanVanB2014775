...
export default function FormRegister() {
    ...
    const {
        ...
        isFetching,
        fetch
    } = useFetch<ApiResponse<registerResponse>>(
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="Hãy nhập tên hiển thị của bạn" {...field} />
                            </FormControl>
                            <FormDescription>Hãy nhập tên hiển thị của bạn</FormDescription>
                            <FormMessage/>
                        </FormItem>
                    )}
                />
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormDescription>Hãy nhập mật khẩu của bạn</FormDescription>
                            <FormMessage/>
                        </FormItem>
                    )}
                />
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormDescription>Hãy nhập lại mật khẩu của bạn</FormDescription>
                            <FormMessage/>
                        </FormItem>
                    )}
                />
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="Hãy nhập thành phố của bạn" {...field} />
                            </FormControl>
                            <FormDescription>Hãy nhập thành phố của bạn</FormDescription>
                            <FormMessage/>
                        </FormItem>
                    )}
                />
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            <FormLabel>Thành phố, Tỉnh thành</FormLabel>
                            <FormControl>
                                <Input placeholder="Hãy nhập địa chỉ của bạn" {...field} />
                            </FormControl>
                            <FormDescription>Hãy nhập thành phố của bạn</FormDescription>
                            <FormMessage/>
                        </FormItem>
                ...
                <button className="w-full" type="submit">
                    <ButtonCustom claesses="bg-Neutral-N900">
                        <span className="text-white capitalize">Tạo Tài Khoản</span>
                    </ButtonCustom>
                </button>
