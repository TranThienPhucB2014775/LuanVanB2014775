...
import { BarChart, CalendarDays, CircleAlert, FileText, Phone, Users } from "lucide-react";
...
const tabs = [
	...
	},
	{
		route: "revenue",
		label: "doanh thu",
		icon: <BarChart className="w-4 h-4 text-black" />
	},
	{
		route: "invitations",
		label: "Lời mời",
	...
	},
	{
		route: "notification",
		label: "Thông báo",
		icon: <CircleAlert className="w-4 h-4 text-black" />
	}
];
			...
			<Tabs defaultValue="" className="mt-4 sm:mt-6">
				...
				<div className="bg-white rounded-lg shadow">
					...
					<TabsContent value="revenue">
						<RevenueStatistics roomId={roomId} />
					</TabsContent>
				...
				<TabsContent value="notification">
					< WriteNotification
						sendNotification={roomApiRequest.sendNotification}
						id={roomId}
					/>
				</TabsContent>
			</Tabs>
