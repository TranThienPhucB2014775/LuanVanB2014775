...
public interface MediaClientService {
    ...
    Map uploadMediaImageCardId(
            @RequestPart("image") MultipartFile file, @RequestParam("imageNames") List<String> fileNames);
    ...
    ResponseEntity<byte[]> getImgCardId(@RequestHeader("authorization") String token, @PathVariable("id") String id);
}
